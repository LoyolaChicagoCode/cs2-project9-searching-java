...
public class Main {
  ...
  public static void main(final String[] args) {
    ...
    final Station belmont =
        new Station("Belmont", Set.of(Line.RED, Line.PURPLE), 41.939956, -87.653324);
    final Station howard =
        new Station("Howard", Set.of(Line.RED, Line.PURPLE, Line.YELLOW), 42.019051, -87.672889);
